...
const formSchema = z.object({
  ...
  position: z.string().min(2, { message: "Please specify a position you're interested in." }),
  coverLetter: z.string().min(30, { message: "Cover letter should be at least 30 characters." }),
...
export function CareersContent() {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: { name: "", email: "", position: "", coverLetter: "", resumeLink: "" },
  });
      ...
      <section className="py-12 md:py-16 px-4 md:px-16" id="apply">
        <div className="container max-w-7xl mx-auto">
          <div className="max-w-4xl mx-auto">
            ...
            >
              We&apos;re always on the lookout for talented people who are passionate about automation, problem-solving, and helping businesses grow smarter.
            </motion.p>
            ...
            >
              ...
              <p className="text-foreground/70 mb-6">
                No openings right now. Send us your resume and we&apos;ll keep you in mind!
              </p>
                  ...
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <FormField control={form.control} name="position" render={({ field }) => (
                      <FormItem className="space-y-2">
                        ...
                        <FormControl><Input placeholder="What role are you interested in?" {...field} disabled={isSubmitting} /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
                    <FormField control={form.control} name="coverLetter" render={({ field }) => (
                      <FormItem className="space-y-2">
                        ...
                        <FormControl><Textarea placeholder="Tell us about yourself and why you're interested in Oblique Path" rows={4} {...field} disabled={isSubmitting} /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
                    <FormField control={form.control} name="resumeLink" render={({ field }) => (
                      <FormItem className="space-y-2">
                        ...
                        <FormControl><Input placeholder="Link to your resume (Google Drive, Dropbox, etc.)" {...field} disabled={isSubmitting} /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
